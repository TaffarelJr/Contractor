...
{
    /// <summary>
    /// An <see cref="ILifetime"/> object that creates a single static instance and caches it.
    /// </summary>
    ...
    ///   </item>
    /// </list></remarks>
    public class StaticLifetime : BaseLifetime
    {
        ...
        public StaticLifetime(Type implementationType, IFactory factory)
            : base(implementationType, factory)
        {
        }

        /// <summary>
        /// Instructs <see cref="BaseLifetime.Factory"/> to construct a single global instance,
