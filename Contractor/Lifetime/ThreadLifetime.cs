...
{
    /// <summary>
    /// An <see cref="ILifetime"/> object that creates a single thread-static instance and caches it.
    /// </summary>
    ...
    ///   </item>
    /// </list></remarks>
    public class ThreadLifetime : BaseLifetime
    {
        [ThreadStatic]
        ...
        public ThreadLifetime(Type implementationType, IFactory factory)
            : base(implementationType, factory)
        {
        }

        /// <summary>
        /// Instructs <see cref="BaseLifetime.Factory"/> to construct a single thread-static instance,
